"""
Benchmark AETHER governance formula on SAP Workflow Mining data.
...
DATA_DIR = AETHER_ROOT / "data" / "external" / "sap_workflow"
...
def main():
    print("=" * 60)
    print("SAP WORKFLOW GOVERNANCE BENCHMARK")
    print("=" * 60)
    ...
    # Benchmark each mode
    benchmark_results = {
        "benchmark": "AETHER SAP Workflow Governance Benchmark (v2 bidirectional)",
        "dataset": {
            "label": "SAP Workflow Mining",
    ...
    benchmarks_path = benchmarks_dir / "sap_workflow.json"
