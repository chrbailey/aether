"""
Train AETHER model on NetSuite 2025 Transaction dataset.

This is the largest real transaction dataset (4.2M source rows, 1367 cases).
Uses the same architecture as other datasets:
...
def main():
    ...
    # Create datasets - longer sequences for this dataset (median 53 events)
    train_dataset = EventSequenceDataset(
        events_path=DATA_DIR / "train_cases.json",
        activity_vocab=activity_vocab,
        resource_vocab=resource_vocab,
        max_seq_len=100,  # Match max_events_per_case from parsing
