#!/usr/bin/env python3
"""Train AETHER model on BPI Challenge 2015 Building Permits dataset.

Uses the same architecture as other process mining models:
  EventEncoder -> TransitionModel -> EnergyScorer -> HierarchicalPredictor

Dataset: ~1,199 cases, ~52,217 events, 398 unique activities
Source: BPI Challenge 2015 - Dutch Municipality Building Permits

This dataset tests model generalization with HIGHEST activity vocabulary.
"""
...
BATCH_SIZE = 32
LR = 3e-4
MAX_SEQ_LEN = 64  # BPI 2015 has moderate sequence lengths
...
def main():
    ...
    logger.info(f"Activity vocab: {activity_vocab.size} tokens (HIGHEST VOCABULARY)")
